...
export const AddQuestions: React.FC = () => {
  ...
  const downloadSampleCSV = () => {
    const rows = [
      ...
      ['Who was the first President of the United States?', 'Thomas Jefferson', 'George Washington', 'Abraham Lincoln', 'John Adams', 'Option B', 'George Washington served as the first president from 1789 to 1797.', 'easy', 'History', 'American Presidents'],
      ['Which empire built the Colosseum in Rome?', 'Greek Empire', 'Persian Empire', 'Roman Empire', 'Byzantine Empire', 'Option C', 'The Colosseum was built by the Roman Empire in the 1st century AD.', 'easy', 'History', 'Ancient Civilizations'],
      ['Who was the first Emperor of China?', 'Qin Shi Huang', 'Han Wudi', 'Kublai Khan', 'Taizong', 'Option A', 'Qin Shi Huang founded the Qin dynasty and unified China in 221 BC.', 'hard', 'History', 'Ancient China'],
      ['The Magna Carta was signed in which year?', '1215', '1066', '1492', '1776', 'Option A', 'The Magna Carta was agreed to by King John of England at Runnymede in June 1215.', 'hard', 'History', 'British History'],
    ];
